...
// export const $oldmoveCount = gameDomain.store(0); // move to playground
// $oldmoveCount.on(scoreUpdateEvent, (state) => ++state).reset(newGameEvent);

// export const $oldplayground = gameDomain.store({
// 	tiles: [],
// 	cells: []
// });
...
// export const $oldgameSaved = combine(
// 	$oldmoveCount,
// 	$oldscore,
// 	$oldplayground,
